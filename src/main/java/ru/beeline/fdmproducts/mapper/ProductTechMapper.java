...
public class ProductTechMapper {
    ...
    public static ProductInfoV2DTO mapToProductInfoV2DTO(Product product,
                                                         UserProfileDTO user,
        ...
        List<TechProductInfoV2DTO> techInfos = product.getTechProducts()
                ...
                .map(tp -> {
                    ...
                    return TechProductInfoV2DTO.builder()
                            .id(tp.getId())
                            .createdDate(tp.getCreatedDate())
                            .lastModifiedDate(tp.getLastModifiedDate())
                            .deletedDate(tp.getDeletedDate())
                            .source(tp.getSource())
                            .tech(tech)
                            .build();
                })
        ...
        return ProductInfoV2DTO.builder()
                .alias(product.getAlias())
                .critical(product.getCritical())
                .description(product.getDescription())
                .gitUrl(product.getGitUrl())
