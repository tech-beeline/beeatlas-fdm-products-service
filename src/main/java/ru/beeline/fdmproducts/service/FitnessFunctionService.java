...
import ru.beeline.fdmproducts.dto.DomainDTO;
...
import ru.beeline.fdmproducts.mapper.FitnessFunctionMapper;
...
public class FitnessFunctionService {
    ...
    public List<GetFitnessFunctionDTO> getAllFitnessFunctions() {
        return fitnessFunctionMapper.mapFitnessFunctionDTO(localFitnessFunctionRepository.findAll());
    }
}